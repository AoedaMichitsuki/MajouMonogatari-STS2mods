...
public sealed class CecilyCharacter : PlaceholderCharacterModel
{
    ...
    /// </summary>
    public override string CustomVisualPath => CecilyArtProvider.Instance.CharacterVisualScenePath;
    public override string CustomIconTexturePath => CecilyArtProvider.Instance.CharacterIconTexturePath;
    public override string CustomCharacterSelectIconPath => CecilyArtProvider.Instance.CharacterSelectIconPath;
    public override string CustomCharacterSelectLockedIconPath => CecilyArtProvider.Instance.CharacterSelectLockedIconPath;
    public override string CustomMapMarkerPath => CecilyArtProvider.Instance.CharacterMapMarkerPath;
}
